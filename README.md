...
This project analyzes Goa’s tourism ecosystem to identify strategies for enhancing tourist engagement and supporting local artisan communities. While tourism contributes 16.4% to Goa's GDP, many artisan livelihoods remain economically marginalized. By translating tourist behavior data into actionable strategies, this project seeks to bridge the gap between commercial tourism and cultural heritage preservation.
...
* Cross-tabulated payment preferences against age demographics to pinpoint the "digital gap".


* Quantified the relationship between repeat visitation and cultural engagement, identifying a strong positive correlation ($r=0.82$).
